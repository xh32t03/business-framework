package com.easyway.business.framework.common.helper;
...
public class ProfilerHelper {
    ...
    public static final class Entry {
        ...
        private void toString(StringBuffer buffer, String prefix1, String prefix2) {
            ...
            Object[] params = new Object[] { message, // {0} - entry信息 
                    ...
                    new Double(percentOfAll) // {5} - 在总时间中所占的时间比例
            };
    ...
    public static enum MessageLevel {
        ...
        NO_MESSAGE("NO_MESSAGE", 0), 
        BRIEF_MESSAGE("BRIEF_MESSAGE", 1), 
        DETAILED_MESSAGE("DETAILED_MESSAGE", 2);
        
        private String code;
        private int    value;

        private MessageLevel(String code, int value) {
            this.code = code;
            this.value = value;
        }
