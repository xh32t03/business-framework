...
import static com.easyway.business.framework.util.Assert.ExceptionType.*;
    ...
    public static <T> T assertNotNull(T object, ExceptionType exceptionType, String message, Object... args) {
        if (object == null) {
            ...
            throw exceptionType.newInstance(
                    getMessage(message, args, "[Assertion failed] - the argument is required; it must not be null"));
        }
 ...
 * @author Michael Zhou
 */
class UnexpectedFailureException extends RuntimeException {
